  ...
  const handleBookmark = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast({ title: "Error", description: error.error || "Bookmark nahi hua.", variant: "destructive" });
      }
    } catch (err) {
      ...
      <div className="flex flex-wrap gap-1.5 px-3 pt-3">
        ...
        >
          <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.447-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.095 3.2 5.076 4.487.709.306 1.262.489 1.694.625.71.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-4.946 1.194c-1.516.79-2.832 1.879-3.775 3.179C2.08 8.945 1.612 10.5 1.612 12.085c0 1.585.468 3.15 1.347 4.506l-1.431 5.203 5.344-1.399c1.272.675 2.718 1.055 4.206 1.055 5.424 0 9.859-4.435 9.859-9.859 0-2.64-1.04-5.12-2.936-6.994-1.895-1.875-4.407-2.909-7.052-2.909z"/>
          </svg>
          WhatsApp
        </button>
        <button
